...
@ControllerAdvice //manejo global de excepciones para todos los controladores
public class RestControllerException {

    private static final Logger logger = LoggerFactory.getLogger(RestControllerException.class);

    @ExceptionHandler(ClienteNotFoundException.class) //excepciones del tipo ClienteNotFoundException
